...
#determine probability for 50 km and remove all probabilities lower. Later I set up a threshold of 1/10000 as the lowest probability of dispersal that we are interested in.
