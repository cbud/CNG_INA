...
With 5 iterations and 5 timesteps and 1800 nodes

[1] "ending parameter combination 37"
Error: cannot allocate vector of size 25.6 Mb
...
```{r INA scene small matrix, error=TRUE}
# CNGv1 <-
#   INAscene(
#     nreals = 50,
